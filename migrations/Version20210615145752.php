 ...
 */
final class Version20210615145752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE programs_id programs_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE programs_id programs_id INT DEFAULT NULL');
    }
}
